...
$pythonSmoke = @(
  ...
  "assert {'architecture','moduleBoundaries','externalComponents','integrationDecisions','dataCenter','skills','readiness'} <= set(review.keys()), 'architecture review bundle smoke failed'",
