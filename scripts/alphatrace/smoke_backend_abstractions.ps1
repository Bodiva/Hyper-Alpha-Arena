...
$pythonSmoke = @(
  ...
  "assert {'architecture','moduleBoundaries','externalComponents','integrationDecisions','dataCenter','skills','agentSkillBindings','readiness'} <= set(review.keys()), 'architecture review bundle smoke failed'",
