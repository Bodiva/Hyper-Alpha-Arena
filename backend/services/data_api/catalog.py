    ...
    def list_resources(self) -> list[DataApiResource]:
        return [
            DataApiResource(
                ...
                store_type="clickhouse_target_or_static_seed",
                status="ready",
            ...
            DataApiResource(
                ...
                store_type="clickhouse_target_static_seed_run_scoped",
                status="ready",
            ...
            DataApiResource(
                ...
                store_type="clickhouse_target_agent_run_projection_static_seed",
                status="ready",
            ),
            DataApiResource(
    ...
    def list_providers(self) -> list[DataApiProvider]:
        return [
            ...
            DataApiProvider(
                ...
                notes="Formal target for structured business and analytical data. Current static/MySQL/JSON paths are transitional until ClickHouse store is implemented.",
            ),
            DataApiProvider(
