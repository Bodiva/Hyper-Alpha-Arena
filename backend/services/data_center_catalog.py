...
def get_data_center_catalog() -> DataCenterCatalog:
    ...
    return DataCenterCatalog(
        ...
        connectors=(
            DataCenterConnector(
                connector_id="static_seed_connector",
                display_name="Static Seed Connector",
                connector_type="internal_seed",
                status="active",
                data_domains=("asset", "evidence", "strategy", "portfolio", "market_data"),
                ingestion_mode="local_read",
                target_store="static_seed_fallback",
                credential_policy="none",
                freshness_policy="deterministic_demo_data",
                notes="Fallback for demos and local development; not production truth.",
            ),
            DataCenterConnector(
