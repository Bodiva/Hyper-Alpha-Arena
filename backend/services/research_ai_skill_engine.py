"""
Research AI Skill Engine

Manages the Skill system for Research AI. Skills are modular, file-based
...
- Enabled state stored in ResearchAiProfile.enabled_skills (JSON array)
...
def get_enabled_skills(all_skills: list[dict], enabled_skills_json: Optional[str]) -> list[dict]:
    ...
    Args:
        ...
        enabled_skills_json: ResearchAiProfile.enabled_skills value (JSON string or None)
