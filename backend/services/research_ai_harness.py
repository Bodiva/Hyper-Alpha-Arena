"""
Research AI harness guardrails.
...
from services.research_ai_tools import execute_hyper_ai_tool
...
def assess_tool_risk(
    ...
    try:
        ...
        logger.warning("[ResearchAI Harness] Preflight failed for %s: %s", tool_name, exc)
        risk_level = RISK_HIGH
